...
maven 内置的`complier`插件默认编译版本为 1.5，若想支持其他的编译版本，则需要自定义其他的编译版本
...
> 参考：[十五、使用 maven-shade-plugin 插件将项目打成可执行的 jar 包](https://blog.csdn.net/newbie_907486852/article/details/80921827)
